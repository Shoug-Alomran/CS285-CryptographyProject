...
public class Encryptor {
    ...
    public static void validatePlainText(String plainText) {
        ...
        if (plainText.length() < 3) {
            throw new IllegalArgumentException(
                    "Plain text cannot be less than 3 letters, use more letters for better security");
        }
    }
    ...
    public static void validateCipherText(String cipherText) {
        ...
        if (cipherText.length() < 4) {
            throw new IllegalArgumentException(
                    "Cipher text cannot be less than 4 letters, use more letters for better security");
        }
    }
}
